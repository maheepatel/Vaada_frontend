  ...
  return (
    <Link className={`vaada-logo vaada-logo--${tone} ${className}`.trim()} href={href} aria-label="Vaada home">
      <svg className="vaada-logo-mark" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path d="M7 15C8.10457 15 9 15.8954 9 17V20C9 21.1046 8.10457 22 7 22H4C2.89543 22 2 21.1046 2 20V17C2 15.8954 2.89543 15 4 15H7Z" className="logo-ink" />
        <path d="M12 12H4.72727C3.22104 12 2 10.779 2 9.27273V4.72727C2 3.22104 3.22104 2 4.72727 2H9.27273C10.779 2 12 3.22104 12 4.72727V12Z" className="logo-coral" />
      </svg>
      <span className="vaada-logo-copy"><strong>VAADA</strong>{tagline && <small>PUBLIC PROMISES · PUBLIC PROOF</small>}</span>
    </Link>
  );
}
