...
const blank: ExtractedDraft = { title: "", promiseText: "", sourceUrl: "", promisedOn: "", deadlineLabel: "", state: "", district: "", category: "Governance", accountableOffice: "", confidence: {}, warnings: [] };
...
export default function SubmitPage() {
  ...
  const extract = async (event: FormEvent) => {
    ...
    try {
      ...
      const endpoint = backendEndpoint("/v1/extract");
